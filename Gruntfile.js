module.exports = function(grunt) {
    grunt.initConfig({
        concat: {
            plugins: {
                src: ['assets/lib/history.js/scripts/bundled/html4+html5/jquery.history.js', 'assets/lib/slick-carousel/slick/slick.min.js', 'assets/lib/gsap/src/minified/TweenMax.min.js', 'assets/oembed/oembed.min.js'],
